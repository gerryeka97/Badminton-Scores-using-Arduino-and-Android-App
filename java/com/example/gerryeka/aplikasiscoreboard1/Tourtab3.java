 ...
 * {@link Tourtab3.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Tourtab3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tourtab3 extends Fragment {
     ...
     * @return A new instance of fragment Tourtab3.
     */
    // TODO: Rename and change types and number of parameters
    public static Tourtab3 newInstance(String param1, String param2) {
        Tourtab3 fragment = new Tourtab3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tourtab3, container,false);

        recyclerView = rootView.findViewById(R.id.tourmatchlist3);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        tourmatches = new ArrayList<Model_tourmatch>();

        Tourtab3.JsonFetch jsonFetch = new Tourtab3.JsonFetch();
        jsonFetch.execute();
    ...
    public class JsonFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
//                URL url = new URL("http://192.168.0.19/loginapp/tourmatches3.php?id_tour="+ tour_id);
                URL url = new URL("http://192.168.43.38/loginapp/tourmatches3.php?id_tour="+ tour_id);
//                URL url = new URL("http://203.189.121.229:9000/loginapp/tourmatches3.php?id_tour="+ tour_id);
