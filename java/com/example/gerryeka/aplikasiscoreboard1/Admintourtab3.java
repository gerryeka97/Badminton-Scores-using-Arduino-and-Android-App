 ...
 * {@link Admintourtab3.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Admintourtab3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Admintourtab3 extends Fragment {
     ...
     * @return A new instance of fragment Admintourtab3.
     */
    // TODO: Rename and change types and number of parameters
    public static Admintourtab3 newInstance(String param1, String param2) {
        Admintourtab3 fragment = new Admintourtab3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_admintourtab3, container,false);

        recyclerView = rootView.findViewById(R.id.admintourmatchlist3);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        tourmatches = new ArrayList<Model_admintourmatch>();

        Admintourtab3.JsonFetch jsonFetch = new Admintourtab3.JsonFetch();
        jsonFetch.execute();
    ...
    public class JsonFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
//                URL url = new URL("http://192.168.0.19/loginapp/admintourmatches3.php?id_tour="+ admintour_id);
//                URL url = new URL("http://203.189.121.229:9000/loginapp/admintourmatches3.php?id_tour="+ admintour_id");
                URL url = new URL("http://192.168.43.38/loginapp/admintourmatches3.php?id_tour="+ admintour_id);
