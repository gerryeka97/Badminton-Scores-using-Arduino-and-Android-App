 ...
 * {@link Admintourtab2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Admintourtab2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Admintourtab2 extends Fragment {
     ...
     * @return A new instance of fragment Admintourtab2.
     */
    // TODO: Rename and change types and number of parameters
    public static Admintourtab2 newInstance(String param1, String param2) {
        Admintourtab2 fragment = new Admintourtab2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_admintourtab2, container,false);

        recyclerView = rootView.findViewById(R.id.admintourmatchlist2);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        tourmatches = new ArrayList<Model_admintourmatch>();

        Admintourtab2.JsonFetch jsonFetch = new Admintourtab2.JsonFetch();
        jsonFetch.execute();
    ...
    public class JsonFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
//                URL url = new URL("http://192.168.0.19/loginapp/admintourmatches2.php?id_tour="+ admintour_id);
//                URL url = new URL("http://203.189.121.229:9000/loginapp/admintourmatches2.php?id_tour="+ admintour_id");
                URL url = new URL("http://192.168.43.38/loginapp/admintourmatches2.php?id_tour="+ admintour_id);
