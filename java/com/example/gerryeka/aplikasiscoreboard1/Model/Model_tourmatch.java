...
public class Model_tourmatch {

    String matchid, name1, name2, set_score1, set_score2, tournament_id, round;

    public Model_tourmatch() {
    }

    public Model_tourmatch(String matchid, String name1, String name2, String set_score1, String set_score2, String tournament_id, String round) {
